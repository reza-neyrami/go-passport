...
type Passport struct {
    ...
    TokenEncryptionKeyCallback func(encrypter *crypto.AEAD) []byte
...
func (p *Passport) tokensCan(scopes []string) *Passport {
    p.Scopes = scopes
    return p
}
...
func (p *Passport) encryptTokensUsing(callback func(encrypter *crypto.AEAD) []byte) *Passport {
