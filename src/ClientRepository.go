...
type ClientRepository interface {
	Create(ctx context.Context, userId uint, name string, redirect string, provider *string, personalAccess bool, password bool, confidential bool) (Client, error)
	...
	FindForUser(ctx context.Context, clientId int, userId uint) (*Client, error)
	ForUser(ctx context.Context, userId uint) ([]Client, error)
	ActiveForUser(ctx context.Context, userId uint) ([]Client, error)
	CreatePersonalAccessClient(ctx context.Context, userId uint, name string, redirect string) (*Client, error)
	CreatePasswordGrantClient(ctx context.Context, userId uint, name string, redirect string, provider *string) (*Client, error)
...
func (r *clientRepository) Create(ctx context.Context, userId uint, name string, redirect string, provider *string, personalAccess bool, password bool, confidential bool) (Client, error) {
	client := Client{
		UserId:               userId,
		Name:                 name,
...
func (r *clientRepository) FindForUser(ctx context.Context, clientId int, userId uint) (*Client, error) {
...
func (r *clientRepository) ForUser(ctx context.Context, userId uint) ([]Client, error) {
...
func (r *clientRepository) ActiveForUser(ctx context.Context, userId uint) ([]Client, error) {
...
func (r *clientRepository) CreatePersonalAccessClient(ctx context.Context, userId uint, name string, redirect string) (*Client, error) {
	var client Client
...
func (r *clientRepository) CreatePasswordGrantClient(ctx context.Context, userId uint, name string, redirect string, provider *string) (*Client, error) {
